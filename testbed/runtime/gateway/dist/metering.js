...
class MeteringService {
    ...
    calculateCost(tenantId, period) {
        ...
        const total_base_cost = tier.base_price_usd +
            cpu_cost +
            network_cost +
            api_cost +
            tool_cost +
