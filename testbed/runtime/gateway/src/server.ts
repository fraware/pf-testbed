...
export class GatewayServer {
  ...
  private setupMiddleware(): void {
    ...
    this.app.use((req, res, next) => {
      ...
      res.on('finish', () => {
        ...
        this.observability.recordRequestComplete(req.path, req.method, res.statusCode, duration);
      });
  ...
  start(): void {
    ...
    this.app.listen(port, host, () => {
      ...
      console.log(`⚙️  Enforce mode: ${this.gateway.isEnforceMode() ? 'ENABLED' : 'DISABLED'}`);
    });
  }
