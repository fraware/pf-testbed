...
describe('Retrieval Gateway', () => {
  ...
  describe('Basic Functionality', () => {
    ...
    it('should generate unique query and result hashes', async () => {
      ...
      expect(response1['metadata'].result_hash).toBe(response2['metadata'].result_hash); // Same data, different query
    });
  ...
  describe('Data Store Operations', () => {
    it('should support CRUD operations', async () => {
      ...
      const deletedData = await dataStore.get('test_tenant', 'test_subject', {});
